...
// The status LED is a two wire jumper with a 2k resistor in series to limit the current to the LED
  ...
  #define STATUS_LED_PIN        26         // Default LED Cathode (-)
#endif
...
#define SHARED_ENABLE_PIN       17               // Hint that the enable pins are shared

// Axis1 RA/Azm step/dir driver
#define AXIS1_ENABLE_PIN        SHARED           // [must be low at boot 12]
#define AXIS1_M0_PIN            23               // SPI MOSI
#define AXIS1_M1_PIN            22               // SPI SCK
...
#define AXIS1_DIR_PIN           15                // [must be high at boot 0]
...
#define AXIS2_M1_PIN            22               // SPI SCK
#define AXIS2_M2_PIN            21                // SPI CS (UART TX)
#if AXIS4_POWER_DOWN != ON
